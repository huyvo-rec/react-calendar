      ...
      <section className={classes.root}>
        ...
        >
          ...
          >
            {isDatepicker && (
              // <Tooltip
              //   title={`${format(new Date(), "dddd, d mmmm", {
              //     locale: locale,
              //   })}`}
            ...
            return (
              <Grid item xs key={`small-calendar-column-header-${index}`}>
                <Typography className={classes.dayHeader}>
                  {format(weekDay, "eeeee", { locale: locale })}
                </Typography>
              </Grid>
            );
          })}
        ...
        {weeks.map((week: any, weekIndex: number) => (
          ...
          >
            {week.map((day: any, dayIndex: number) => {
              const isToday =
                format(day, "dMMyyyy") == format(new Date(), "dMMyyyy");
           
              const isSelected = selectedInternalDate && !isToday && format(day, "dMMyyyy") === format(selectedInternalDate, "dMMyyyy");
              ...
              return (
                ...
                >
                  <Typography
                    ...
                    onClick={() => {selectDate({ newDate: day });console.log(day)}}
                  >
                    {day.getDate()}
                  </Typography>
                </Grid>
